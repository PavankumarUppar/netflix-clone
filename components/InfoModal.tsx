...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <div className={`z-50 transition duration-300 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'} bg-black bg-opacity-80 flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0`}>
